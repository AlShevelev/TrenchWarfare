...
///
/// See the documentation for Mockito's code generation for more information.
class MockMapMetadataRead extends _i1.Mock implements _i6.MapMetadataRead {
  MockMapMetadataRead() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  List<_i5.Nation> getEnemies(_i5.Nation? myNation) => (super.noSuchMethod(
        Invocation.method(
          #getEnemies,
          [myNation],
        ),
  ...
  @override
  List<_i5.Nation> getAllied(_i5.Nation? myNation) => (super.noSuchMethod(
        Invocation.method(
          #getAllied,
          [myNation],
        ),
  ...
  @override
  List<_i5.Nation> getNeutral(_i5.Nation? myNation) => (super.noSuchMethod(
        Invocation.method(
          #getNeutral,
          [myNation],
        ),
  ...
  @override
  List<_i5.Nation> getAll() => (super.noSuchMethod(
        Invocation.method(
          #getAll,
          [],
        ),
