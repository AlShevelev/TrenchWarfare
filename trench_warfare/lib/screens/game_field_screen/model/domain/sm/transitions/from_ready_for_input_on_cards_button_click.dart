...
class FromReadyForInputOnCardsButtonClick {
  ...
  State process() {
    ...
    final cards = CardsSelectionControls(
      ...
      units: [
        _mapUnit(Unit.create(UnitType.infantry), unitBuildCalculator),
        _mapUnit(Unit.create(UnitType.cavalry), unitBuildCalculator),
        _mapUnit(Unit.create(UnitType.machineGuns), unitBuildCalculator),
        _mapUnit(Unit.create(UnitType.artillery), unitBuildCalculator),
        _mapUnit(Unit.create(UnitType.machineGunnersCart), unitBuildCalculator),
        _mapUnit(Unit.create(UnitType.armoredCar), unitBuildCalculator),
        _mapUnit(Unit.create(UnitType.tank), unitBuildCalculator),
        _mapUnit(Carrier.create(), unitBuildCalculator),
        _mapUnit(Unit.create(UnitType.destroyer), unitBuildCalculator),
        _mapUnit(Unit.create(UnitType.cruiser), unitBuildCalculator),
        _mapUnit(Unit.create(UnitType.battleship), unitBuildCalculator),
      ],
      productionCenters: [
