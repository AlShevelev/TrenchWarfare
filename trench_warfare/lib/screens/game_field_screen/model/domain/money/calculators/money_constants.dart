...
class _MoneyConstants {
  ...
  static final gasAttackCost = MoneyUnit(currency: 40, industryPoints: 10);
  static final flechettesCost = MoneyUnit(currency: 60, industryPoints: 5);
  ...
  static final propagandaCost = MoneyUnit(currency: 10, industryPoints: 0);
}